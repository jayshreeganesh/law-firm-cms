...
if (isset($_GET['lang'])) {
    $allowed_langs = ['en', 'as', 'awa', 'bn', 'bho', 'brx', 'hne', 'doi', 'gu', 'bgc', 'hi', 'kn', 'ks', 'gom', 'mag', 'mai', 'ml', 'mni', 'mr', 'mwr', 'ne', 'or', 'pa', 'sa', 'sat', 'sd', 'ta', 'te', 'ur'];
        ...
        <div class="container" style="display: flex; justify-content: space-between; align-items: center;">
            <div style="display: flex; gap: 10px; align-items: center;">
                ...
                <select onchange="window.location.href='?lang='+this.value" style="padding: 2px 5px; border-radius: 4px; border: 1px solid #cbd5e1; font-size: 0.85rem;">
                    ...
                    <option value="awa" <?= $current_lang == 'awa' ? 'selected' : '' ?>>अवधी (Awadhi)</option>
                    <option value="bn" <?= $current_lang == 'bn' ? 'selected' : '' ?>>বাংলা (Bengali)</option>
                    <option value="bho" <?= $current_lang == 'bho' ? 'selected' : '' ?>>भोजपुरी (Bhojpuri)</option>
                    <option value="brx" <?= $current_lang == 'brx' ? 'selected' : '' ?>>बर’ (Bodo)</option>
                    <option value="hne" <?= $current_lang == 'hne' ? 'selected' : '' ?>>छत्तीसगढ़ी (Chhattisgarhi)</option>
                    ...
                    <option value="bgc" <?= $current_lang == 'bgc' ? 'selected' : '' ?>>हरियाणवी (Haryanvi)</option>
                    ...
                    <option value="mag" <?= $current_lang == 'mag' ? 'selected' : '' ?>>मगही (Magahi)</option>
                    ...
                    <option value="mwr" <?= $current_lang == 'mwr' ? 'selected' : '' ?>>मारवाड़ी (Marwari)</option>
